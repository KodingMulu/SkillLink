...
import { Users, FileText, DollarSign, Briefcase, ChevronRight, MoreVertical } from "lucide-react";
  ...
  return (
    <DashboardLayout role="client">
      <div className="flex justify-between items-end mb-8">
        ...
        <button className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-medium shadow-lg shadow-blue-600/20 transition-all">
